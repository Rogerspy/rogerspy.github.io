	...
	<body>
		...
		<div class="container-x", id="box">
			<div class="scrollbar" id="style-1">
				<div class="navbox">
					<ul class="nav">
						<li><a href="index.html">图像分类</a></li>
						<li><a href="data_clean.html">数据清洗与生成</a></li>
						<li><a href="multi_label.html">多标签分类</a></li>
						<li><a href="nlp.html">NLP</a></li>
						<li><a href="bp.html">后向传播</a></li>
						<li><a href="regularization.html">正则化</a></li>
						<li><a href="resnet.html">Resnet</a></li>
						<li><a href="foundation.html">从基础开始深度学习</a></li>
						<li><a href="train_model.html">如何训练你的模型</a></li>
						<li><a href="look_into_model.html">深入了解模型</a></li>
						<li><a href="data_api.html">数据块API</a></li>
						<li><a href="train_technique.html">高级训练技巧</a></li>
						<li><a href="swift_basic.html">深度学习swift基础</a></li>
						<li><a href="swift.html">swift</a></li>
					</ul>
				</div>
			</div>
			<section class="video-section video-section--light" id="demo">
			    <h4 class="title-video heading-video">从基础开始深度学习</h4>
				<div class="container-video">
				    <iframe src="https://player.bilibili.com/player.html?aid=57181259&cid=99852899&page=7" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true"> </iframe>
				</div>
			</section>
		</div>
